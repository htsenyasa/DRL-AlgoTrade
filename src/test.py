...
networkSettings_ = network.networkSettings(inputLayerSize=100, hiddenLayerSize=100, outputLayerSize=2, dropout=0.2)
...
tdqn.TDQNAgent(tdqnSettings_, networkSettings_)